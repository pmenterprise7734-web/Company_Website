...
export default function AdminAddProduct() {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full">
      <p className="text-[25px] text-[#000] self-center p-5">
        ...
        <div className="flex flex-col h-[70vh] w-[70vw] border-2 border-[#d4d4d4] rounded-[15px] justify-center items-center px-10">
          ...
          <div className="flex flex-row w-full items-center justify-between pt-5">
            ...
            >
              {AllCatagory?.length > 0 ? (
                ...
                <MenuItem disabled>
                  There is nothing to show. Please refresh and try again
                </MenuItem>
              )}
            </TextField>
            <TextField
          ...
          <div className="flex flex-row w-full items-center justify-between pt-5">
            ...
            <div className="flex h-[150px] w-[20vw] bg-[#000] rounded-[10px] justify-center items-center cursor-pointer">
              {PreviewImg == "" ? (
                <div
                  className="flex h-full w-full border cursor-pointer items-center justify-center"
      ...
      <div className="flex flex-row justify-center">
        <div
          className={`flex h-[50px] w-[200px] self-end m-5 rounded-[10px] justify-center self-center items-center bg-[#e62020] cursor-pointer hover:scale-110 duration-300 `}
          onClick={() => {
            CancelAddProduct();
          }}
        >
        ...
        <div
          className={`flex h-[50px] w-[200px] self-end m-5 rounded-[10px] justify-center self-center items-center ${!UploadingImg ? "bg-[#2ba31d] cursor-pointer hover:scale-110 duration-300" : "bg-[#757575] cursor-not-allowed"} `}
          onClick={() => {
        ...
        >
          <div className="flex flex-col p-10 bg-[#FFF]">
            <p className="flex text-[#000]">
              <p className="font-medium">Name:</p> &nbsp; {Name}
            </p>
            <p className="flex text-[#000]">
              <p className="font-medium">Capacity:</p> &nbsp; {Capacity}
            </p>
            <p className="flex text-[#000]">
              <p className="font-medium">Catagory:</p> &nbsp; {Catagory}
            </p>
            <p className="flex text-[#000]">
              <p className="font-medium">Company:</p> &nbsp; {CompanyName}
            </p>
            <p className="flex text-[#000]">
              <p className="font-medium">PanSize:</p> &nbsp; {PanSize}
            </p>
            <p className="flex text-[#000]">
              <p className="font-medium">Accuracy:</p> &nbsp; {Accuracy}
            </p>
            <p className="flex text-[#000]">
              <p className="font-medium">Description:</p> &nbsp; {Description}
            </p>
            <p className="flex text-[#000]">
              <p className="font-medium">Model:</p> &nbsp; {Model}
            </p>
          </div>

          <div className="flex flex-row gap-4 m-4">
            <p
              className="flex py-3 px-10 rounded-[10px] text-[#FFF] bg-[#e62020] cursor-pointer hover:scale-110 active:scale-90 duration-200"
              onClick={() => {
                CloseSubmitModal();
              }}
            >
            ...
            <p
              className="flex py-3 px-10 rounded-[10px] text-[#FFF] bg-[#2ba31d] cursor-pointer hover:scale-110 active:scale-90 duration-200"
              onClick={() => {
                NewProduct ? Update(Id) : !UploadingImg && onSubmit();
              }}
            >
              Submit
            </p>
