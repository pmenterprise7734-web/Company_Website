...
export default function CatagoryShow({Name, Image, Value, BName}) {
  return (
    <div className="flex flex-col flex-shrink-0 w-[45vw] md:w-[20vw] aspect-[3/3.8] items-center my-2">
      <div className="flex flex-col h-[100%] w-[100%] rounded-[10px] items-center justify-center border border-[#FFB720]">
        ...
        <div className="flex flex-col h-[25%] w-full bg-[#0B1F3A] rounded-b-[10px] justify-center items-center">
          <p className="text-sm md:text-lg 2xl:text-xl font-semibold text-[#FFF]">{Name}</p>
